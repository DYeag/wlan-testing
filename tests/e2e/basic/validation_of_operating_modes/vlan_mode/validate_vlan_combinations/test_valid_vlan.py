...
pytestmark = [pytest.mark.vlan_combination_test, pytest.mark.valid,
...
setup_params_general = {
    ...
    "ssid_modes": {
        ...
        "wpa2_personal": [
            {"ssid_name": "ssid_wpa2p_2g", "appliedRadios": ["is2dot4GHz"], "security_key": "something", "vlan": 4},
            {"ssid_name": "ssid_wpa2p_5g", "appliedRadios": ["is5GHzU", "is5GHz", "is5GHzL"],
             "security_key": "something", "vlan": 4}]},
    "rf": {},
    "radius": False
}
