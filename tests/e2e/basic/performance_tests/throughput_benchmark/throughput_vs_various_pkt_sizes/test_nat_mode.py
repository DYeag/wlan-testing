...
class TestThroughputVsPktNAT2G(object):
    ...
    def test_client_open_pkt_custom_2g(self, get_vif_state,
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       ...
                                       vlan_id=vlan, dut_name=dut_name, pkt_size="Custom")
    ...
    @pytest.mark.twog
    @pytest.mark.pktcustom
    def test_client_wpa_personal_pkt_custom_2g(self, get_vif_state,
                                       lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
    ...
    @pytest.mark.twog
    @pytest.mark.pktcustom
    def test_client_wpa2_personal_pkt_custom_2g(self, get_vif_state,
                                       lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
    ...
    @pytest.mark.twog
    @pytest.mark.pktcustom
    def test_client_wpa3_personal_pkt_custom_2g(self, get_vif_state,
                                       lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
...
class TestThroughputVsPktNAT5G(object):
    ...
    @pytest.mark.fivg
    @pytest.mark.pktcustom
    def test_client_open_pkt_custom_5g(self, get_vif_state,
                                       lf_test, station_names_fivg, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
           pytest -m "throughput_vs_pkt and nat and open and fivg"
        """
        profile_data = setup_params_general["ssid_modes"]["open"][0]
        ssid_name = profile_data["ssid_name"]
    ...
    @pytest.mark.fivg
    @pytest.mark.pktcustom
    def test_client_wpa_personal_pkt_custom_5g(self, get_vif_state,
                                       lf_test, station_names_fivg, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
           pytest -m "throughput_vs_pkt and nat and wpa_personal and fivg"
        """
        profile_data = setup_params_general["ssid_modes"]["wpa_personal"][0]
        ssid_name = profile_data["ssid_name"]
    ...
    @pytest.mark.fivg
    @pytest.mark.pktcustom
    def test_client_wpa2_personal_pkt_custom_5g(self, get_vif_state,
                                                lf_test, station_names_fivg, create_lanforge_chamberview_dut,
                                                get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
           pytest -m "throughput_vs_pkt and nat and wpa2_personal and fivg"
        """
        profile_data = setup_params_general["ssid_modes"]["wpa2_personal"][0]
        ssid_name = profile_data["ssid_name"]
    ...
    @pytest.mark.fivg
    @pytest.mark.pktcustom
    def test_client_wpa3_personal_pkt_custom_5g(self, get_vif_state,
                                       lf_test, station_names_fivg, create_lanforge_chamberview_dut,
                                       get_configuration):
        """Throughput Vs Pkt Sizes nat Mode
           pytest -m "throughput_vs_pkt and nat and wpa3_personal and fivg"
        """
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][0]
        ssid_name = profile_data["ssid_name"]
